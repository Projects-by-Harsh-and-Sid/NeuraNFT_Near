...
export class NeuraNFT {
    ...
    // maxAccess          = new LookupMap('ma');          // collectionId_tokenId -> AccessLevel
        ...
        // Storage for NFTs and metadata
        nftTokens          = new UnorderedMap('t');           // collectionId_tokenId -> NFTInfo
        nftMetadata        = new UnorderedMap('m');           // collectionId_tokenId -> Metadata
        tokenBalances      = new UnorderedMap('b');         // owner -> total NFTs
        collectionBalances = new UnorderedMap('cb');   // owner_collectionId -> collection NFTs
        
        // Collections storage
        collections        = new UnorderedMap('c');        // collectionId -> CollectionMetadata
        nextTokenId        = new UnorderedMap('n');          // collectionId -> next token id
        nextCollectionId   = 1;
        
        // Access control storage
        nftAccess          = new UnorderedMap('a');            // collectionId_tokenId_user -> AccessLevel
        defaultAccess      = new UnorderedMap('da');       // collectionId_tokenId -> AccessLevel
        maxAccess          = new UnorderedMap('ma');          // collectionId_tokenId -> AccessLevel
    ...
    getNFTAccessUsers({ collectionId, tokenId }) {
        ...
        const accessKeys = this.nftAccess._keys;
